...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('attributes.store') }}" method="post" name="add_image" enctype="multipart/form-data">
  ...
  <tr>
    ...
    @foreach ($pro as $attribute)
      <tr>
        ...
        <td>
          <a class="btn btn-xs btn-primary" href="{{ route('attributes.edit',$attribute->id) }}">Edit</a>
